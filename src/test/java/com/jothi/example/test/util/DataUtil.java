package com.jothi.example.test.util;

import com.jothi.example.DTO.PriceDTO;
import com.jothi.example.DTO.ProductDTO;
import com.jothi.example.DTO.ProductPriceDTO;
import com.jothi.example.domain.AvailableToPromiseNetworkVO;
import com.jothi.example.domain.ItemVO;
import com.jothi.example.domain.ProductDescriptionVO;
...
public class DataUtil {
	...
	public final static RootVO mockRootVOVO()
	{
		...
		rootvo.setProduct(productvo);
		return (rootvo);
		
	}
	
	public final static ProductPriceVO mockProductPriceVO()
	{
		ProductPriceVO ppvo = new ProductPriceVO();
		ppvo.setPrice(45.45);
		ppvo.setCurrency("USD");
		return (ppvo);
		
	}
	
	public final static ProductPriceDTO mockProductPriceDTO()
	{
		ProductDTO pd = new ProductDTO();
		pd.setProductId(123456789L);
		pd.setProductName("Testing");
