...
public class AttributesVO implements Serializable
{
    ...
    private final static long serialVersionUID = -9076272815635834450L;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("giftWrapable", giftWrapable).append("hasProp65", hasProp65).append("isHazmat", isHazmat).append("manufacturingBrand", manufacturingBrand).append("maxOrderQty", maxOrderQty).append("streetDate", streetDate).append("mediaFormat", mediaFormat).append("merchClass", merchClass).append("merchClassid", merchClassid).append("merchSubclass", merchSubclass).append("returnMethod", returnMethod).append("shipToRestriction", shipToRestriction).toString();
    }
